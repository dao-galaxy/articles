...
这是一次运用区块链技术、以DAO的范式对基于流量的互联网商业模式进行探索的社会实验。我们对自己前进的方向充满美好想象，并全力以赴。在这条由我们开辟的新赛道上，不管谁取得成功，都是对DAO Galaxy价值的彰显。
...
#### 4）WEB3.0 的核心价值观：数据归用户所有，在基于流量的商业模式中用户拥有分享产品价值的权利。
...
## Dao广场
这是一个程序员以及互联网从业者的聚集地，一个拥有治理协议和协作工具的Dao孵化器，一个DApp Store。
Dao广场将在Dao的发起，生产力的聚集，融资，协作分工，组织生产，产品运营等环节进行全面赋能。

## 开发团队
这是一个以Dao范式进行运作的团队。我们基于互惠前提下利己最大化的原则围绕共同的愿景进行生产，并分享成果与喜悦。我们也欢迎更多的Builder加入我们。
